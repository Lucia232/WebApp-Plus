...
> {
  ...
  constructor(
    @inject('datasources.mongodb') dataSource: MongodbDataSource, @repository.getter('EmpresaRepository') protected empresaRepositoryGetter: Getter<EmpresaRepository>, @repository.getter('MensajesEmpleadosRepository') protected mensajesEmpleadosRepositoryGetter: Getter<MensajesEmpleadosRepository>,
  ) {
